...
10. **Changelog**: Never append release notes by editing `packages/*/CHANGELOG.md` manually—use Changesets (`pnpm run changeset`, commit `.changeset/*.md`). See `.claude/skills/release/SKILL.md`.
