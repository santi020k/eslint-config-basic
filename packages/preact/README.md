...
[![npm version](https://img.shields.io/npm/v/@santi020k/eslint-config-preact.svg)](https://www.npmjs.com/package/@santi020k/eslint-config-preact)
[![npm downloads](https://img.shields.io/npm/dm/@santi020k/eslint-config-preact.svg)](https://www.npmjs.com/package/@santi020k/eslint-config-preact)
[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/santi020k/eslint-config-basic/blob/main/LICENSE)

## Installation

```sh
npm install -D eslint @santi020k/eslint-config-basic @santi020k/eslint-config-preact
```
...
- [Preact guide](https://eslint.santi020k.com/frameworks/preact)
...
- [Changelog](https://github.com/santi020k/eslint-config-basic/blob/main/packages/preact/CHANGELOG.md)
