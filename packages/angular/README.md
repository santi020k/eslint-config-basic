...
[![npm version](https://img.shields.io/npm/v/@santi020k/eslint-config-angular.svg)](https://www.npmjs.com/package/@santi020k/eslint-config-angular)
[![npm downloads](https://img.shields.io/npm/dm/@santi020k/eslint-config-angular.svg)](https://www.npmjs.com/package/@santi020k/eslint-config-angular)
[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/santi020k/eslint-config-basic/blob/main/LICENSE)

## Installation

```sh
npm install -D eslint @santi020k/eslint-config-basic @santi020k/eslint-config-angular
```
...
- [Angular guide](https://eslint.santi020k.com/frameworks/angular)
...
- [Changelog](https://github.com/santi020k/eslint-config-basic/blob/main/packages/angular/CHANGELOG.md)
