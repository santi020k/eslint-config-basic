...
Qwik support for projects using the shared flat-config toolkit.

[![npm version](https://img.shields.io/npm/v/@santi020k/eslint-config-qwik.svg)](https://www.npmjs.com/package/@santi020k/eslint-config-qwik)
[![npm downloads](https://img.shields.io/npm/dm/@santi020k/eslint-config-qwik.svg)](https://www.npmjs.com/package/@santi020k/eslint-config-qwik)
[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/santi020k/eslint-config-basic/blob/main/LICENSE)

## Installation

```sh
npm install -D eslint @santi020k/eslint-config-basic @santi020k/eslint-config-qwik
```
...
- [Qwik guide](https://eslint.santi020k.com/frameworks/qwik)
...
- [Changelog](https://github.com/santi020k/eslint-config-basic/blob/main/packages/qwik/CHANGELOG.md)
