 ...
 */
export const stencil: TSESLint.FlatConfig.ConfigArray = defineLazyConfig('stencil', () => {
  const stencilPlugin = loadDefault<typeof StencilPlugin>('@stencil-community/eslint-plugin')
