...
description: DX-first ESLint 9/10+ docs for JavaScript, TypeScript, React, Next.js, Astro, Vue, Svelte, Solid, Angular, NestJS, Expo, Qwik, Remix, and modern tooling.
...
features:
  ...
  - title: 12 framework guides
    details: React, Next.js, Astro, Vue, Svelte, Solid, Angular, NestJS, Expo, Qwik, Remix, and TypeScript each have dedicated setup docs.
