...
- Integrations are enabled through enums from the main package instead of separate config objects in application code.
...
- Use the base package alone for JavaScript, TypeScript, framework configs, runtime detection, and integrations.
...
- Use [Integrations](/tooling/overview) when the main need is integrating Tailwind, Vitest, Prettier, Markdown, Unicorn, or similar packages.
