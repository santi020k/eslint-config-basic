---
title: "Configuration"
description: "The main package composes the final config array from a small set of clear inputs:"
---
...
| Next.js | `@santi020k/eslint-config-next` | [Dedicated Page](/v1/frameworks/next). Requires `react`. |
| Astro | `@santi020k/eslint-config-astro` | [Dedicated Page](/v1/frameworks/astro). |
| Vue | `@santi020k/eslint-config-vue` | [Dedicated Page](/v1/frameworks/vue). |
| Svelte | `@santi020k/eslint-config-svelte` | [Dedicated Page](/v1/frameworks/svelte). |
| Solid | `@santi020k/eslint-config-solid` | [Dedicated Page](/v1/frameworks/solid). |
| Qwik | `@santi020k/eslint-config-qwik` | [Dedicated Page](/v1/frameworks/qwik). |
| Remix | `@santi020k/eslint-config-remix` | [Dedicated Page](/v1/frameworks/remix). Commonly paired with `react` in Remix apps. |
| Hono | `@santi020k/eslint-config-hono` | [Dedicated Page](/v1/frameworks/hono). Optimized for Hono and edge runtimes. |
| Angular | `@santi020k/eslint-config-angular` | [Dedicated Page](/v1/frameworks/angular). |
...
See the dedicated section for the full catalog: [Tooling Overview](/v1/tooling/overview)
