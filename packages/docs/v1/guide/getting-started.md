...
- Continue with [Installation](/v1/guide/installation)
- Review [Configuration](/v1/guide/configuration)
- Use [CLI](/v1/guide/cli) if you want scaffolding
- Jump to [Framework Guides](/v1/frameworks/typescript)
