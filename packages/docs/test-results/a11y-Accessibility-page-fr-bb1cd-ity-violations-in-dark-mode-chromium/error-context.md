...
- Name: a11y.spec.ts >> Accessibility >> page /frameworks/vue/ should have no accessibility violations in dark mode
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<a href=\"/frameworks/vue/\" aria-current=\"page\" class=\"astro-ujldrfsy\"> <span class=\"astro-ujldrfsy\">Vue</span>  </a>",
+                 "target": Array [
+                   "a[aria-current=\"page\"]",
+                 ],
+               },
...
+         "html": "<span class=\"astro-ujldrfsy\">Vue</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
          ...
          - list [ref=e170]:
            ...
            - listitem [ref=e181]:
              - link "Related Pages" [ref=e182] [cursor=pointer]:
                - /url: "#related-pages"
      - main [ref=e184]:
        - heading "Vue" [level=1] [ref=e187]
        - generic [ref=e189]:
          - generic [ref=e190]:
            - paragraph [ref=e191]:
              - text: Use Vue support from the main v2 package. Application projects no longer install a separate
              - code [ref=e192]: "@santi020k/eslint-config-vue"
              - text: package.
            - generic [ref=e193]:
            ...
            - list [ref=e288]:
              - listitem [ref=e289]: Vue single-file component rules.
              - listitem [ref=e290]:
            ...
            - list [ref=e301]:
              ...
              - listitem [ref=e303]:
                ...
                - link "v1 Vue guide" [ref=e304] [cursor=pointer]:
          ...
          - generic [ref=e319]:
            - generic [ref=e320]:
              - link "Edit page" [ref=e321] [cursor=pointer]:
                - /url: https://github.com/santi020k/eslint-config-basic/edit/main/packages/docs/src/content/docs/frameworks/vue.md
                - img [ref=e322]
                - text: Edit page
              - paragraph [ref=e324]:
                - text: "Last updated:"
            ...
            - generic [ref=e326]:
              - link "Previous Astro" [ref=e327] [cursor=pointer]:
                - /url: /frameworks/astro/
                - img [ref=e328]
                - generic [ref=e330]:
                  - text: Previous
                  - text: Astro
              - link "Next Svelte" [ref=e331] [cursor=pointer]:
                - /url: /frameworks/svelte/
                - img [ref=e332]
                - generic [ref=e334]:
                  - text: Next
