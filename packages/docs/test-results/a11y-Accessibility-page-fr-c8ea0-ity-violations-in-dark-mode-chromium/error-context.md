...
- Name: a11y.spec.ts >> Accessibility >> page /frameworks/typescript/ should have no accessibility violations in dark mode
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<a href=\"/frameworks/typescript/\" aria-current=\"page\" class=\"astro-ujldrfsy\"> <span class=\"astro-ujldrfsy\">TypeScript</span> <span class=\"sl-badge success small  astro-ujldrfsy astro-246wmyaq\">Core</span> </a>",
+                 "target": Array [
+                   "a[aria-current=\"page\"]",
+                 ],
+               },
...
+         "html": "<span class=\"astro-ujldrfsy\">TypeScript</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[aria-current=\"page\"] > span:nth-child(1)",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "html": "<span class=\"sl-badge success small  astro-ujldrfsy astro-246wmyaq\">Core</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[aria-current=\"page\"] > .success.sl-badge.small",
+         ],
+       },
+     ],
+     "tags": Array [
          ...
          - list [ref=e170]:
            ...
            - listitem [ref=e175]:
              - link "Configure" [ref=e176] [cursor=pointer]:
                - /url: "#configure"
            - listitem [ref=e177]:
              - link "Typed Projects" [ref=e178] [cursor=pointer]:
                - /url: "#typed-projects"
            - listitem [ref=e179]:
              - link "Related Pages" [ref=e180] [cursor=pointer]:
                - /url: "#related-pages"
      - main [ref=e182]:
        - heading "TypeScript" [level=1] [ref=e185]
        - generic [ref=e187]:
          - generic [ref=e188]:
            - paragraph [ref=e189]: TypeScript support is enabled from the main v2 package. There is no separate application-level install for TypeScript config.
            - generic [ref=e190]:
              - heading "Install" [level=2] [ref=e191]
              - link "Section titled “Install”" [ref=e192] [cursor=pointer]:
                - /url: "#install"
                - img [ref=e194]
                - generic [ref=e196]: Section titled “Install”
            - figure "pnpm" [ref=e198]:
              - generic [ref=e200]: pnpm
              - code [ref=e202]:
                - generic [ref=e204]: pnpm add -D @santi020k/eslint-config-basic
              - button "Copy to clipboard" [ref=e206] [cursor=pointer]
            - figure "npm" [ref=e209]:
              - generic [ref=e211]: npm
              - code [ref=e213]:
                - generic [ref=e215]: npm install -D @santi020k/eslint-config-basic
              - button "Copy to clipboard" [ref=e217] [cursor=pointer]
            - figure "yarn" [ref=e220]:
              - generic [ref=e222]: yarn
              - code [ref=e224]:
                - generic [ref=e226]: yarn add -D @santi020k/eslint-config-basic
              - button "Copy to clipboard" [ref=e228] [cursor=pointer]
            - figure "bun" [ref=e231]:
              - generic [ref=e233]: bun
              - code [ref=e235]:
                - generic [ref=e237]: bun add -d @santi020k/eslint-config-basic
              - button "Copy to clipboard" [ref=e239] [cursor=pointer]
            - generic [ref=e241]:
              - heading "Configure" [level=2] [ref=e242]
              - link "Section titled “Configure”" [ref=e243] [cursor=pointer]:
                - /url: "#configure"
                - img [ref=e245]
                - generic [ref=e247]: Section titled “Configure”
            - figure [ref=e249]:
              - code [ref=e252]:
                - generic [ref=e254]: "import { defineConfig } from '@santi020k/eslint-config-basic'"
                - generic [ref=e258]: "export default await defineConfig({"
                - generic [ref=e260]: "typescript: true"
                - generic [ref=e263]: "})"
              - button "Copy to clipboard" [ref=e265] [cursor=pointer]
            - paragraph [ref=e267]:
              - text: If a
              - code [ref=e268]: tsconfig.json
              - text: or
              - code [ref=e269]: tsconfig.base.json
              - text: exists,
              - code [ref=e270]: eslintConfig()
              - text: can detect TypeScript automatically.
            - generic [ref=e271]:
              - heading "Typed Projects" [level=2] [ref=e272]
              - link "Section titled “Typed Projects”" [ref=e273] [cursor=pointer]:
                - /url: "#typed-projects"
                - img [ref=e275]
                - generic [ref=e277]: Section titled “Typed Projects”
            - paragraph [ref=e278]:
              - text: Use
              - code [ref=e279]: tsconfigRootDir
              - text: when your project layout needs an explicit root for parser options.
            - figure [ref=e281]:
              - code [ref=e284]:
                ...
                - generic [ref=e292]: "tsconfigRootDir: import.meta.dirname,"
                - generic [ref=e295]: "typescript: true"
                - generic [ref=e298]: "})"
              - button "Copy to clipboard" [ref=e300] [cursor=pointer]
            - generic [ref=e302]:
              - heading "Related Pages" [level=2] [ref=e303]
              - link "Section titled “Related Pages”" [ref=e304] [cursor=pointer]:
                - /url: "#related-pages"
                - img [ref=e306]
                - generic [ref=e308]: Section titled “Related Pages”
            - list [ref=e309]:
              - listitem [ref=e310]:
                - link "Installation" [ref=e311] [cursor=pointer]:
                  - /url: /guide/installation
              - listitem [ref=e312]:
                - link "Configuration" [ref=e313] [cursor=pointer]:
                  - /url: /guide/configuration
              - listitem [ref=e314]:
                - link "v1 TypeScript guide" [ref=e315] [cursor=pointer]:
                  - /url: /v1/frameworks/typescript
          - generic [ref=e316]:
            - generic [ref=e317]:
              - link "Edit page" [ref=e318] [cursor=pointer]:
                - /url: https://github.com/santi020k/eslint-config-basic/edit/main/packages/docs/src/content/docs/frameworks/typescript.md
                - img [ref=e319]
                - text: Edit page
              - paragraph [ref=e321]:
                - text: "Last updated:"
                - time [ref=e322]: Jun 9, 2026
            - generic [ref=e323]:
              - link "Previous Migrate from v1" [ref=e324] [cursor=pointer]:
                - /url: /guide/migration-v1-to-v2/
                - img [ref=e325]
                - generic [ref=e327]:
                  - text: Previous
                  - text: Migrate from v1
              - link "Next React" [ref=e328] [cursor=pointer]:
                - /url: /frameworks/react/
                - img [ref=e329]
                - generic [ref=e331]:
                  - text: Next
