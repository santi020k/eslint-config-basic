...
- Name: a11y.spec.ts >> Accessibility >> page /frameworks/react/ should have no accessibility violations in dark mode
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<a href=\"/frameworks/react/\" aria-current=\"page\" class=\"astro-ujldrfsy\"> <span class=\"astro-ujldrfsy\">React</span>  </a>",
+                 "target": Array [
+                   "a[aria-current=\"page\"]",
+                 ],
+               },
...
+         "html": "<span class=\"astro-ujldrfsy\">React</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
          ...
          - list [ref=e170]:
            ...
            - listitem [ref=e181]:
              - link "Related Pages" [ref=e182] [cursor=pointer]:
                - /url: "#related-pages"
      - main [ref=e184]:
        - heading "React" [level=1] [ref=e187]
        - generic [ref=e189]:
          - generic [ref=e190]:
            - paragraph [ref=e191]:
              - text: Use React support from the main v2 package. Application projects no longer install a separate
              - code [ref=e192]: "@santi020k/eslint-config-react"
              - text: package.
            - generic [ref=e193]:
            ...
            - list [ref=e288]:
              - listitem [ref=e289]: React component and Hooks rules.
              - listitem [ref=e290]:
            ...
            - list [ref=e301]:
              ...
              - listitem [ref=e303]:
                ...
                - link "v1 React guide" [ref=e304] [cursor=pointer]:
          ...
          - generic [ref=e319]:
            - generic [ref=e320]:
              - link "Edit page" [ref=e321] [cursor=pointer]:
                - /url: https://github.com/santi020k/eslint-config-basic/edit/main/packages/docs/src/content/docs/frameworks/react.md
                - img [ref=e322]
                - text: Edit page
              - paragraph [ref=e324]:
                - text: "Last updated:"
            ...
            - generic [ref=e326]:
              - link "Previous TypeScript" [ref=e327] [cursor=pointer]:
                - /url: /frameworks/typescript/
                - img [ref=e328]
                - generic [ref=e330]:
                  - text: Previous
                  - text: TypeScript
              - link "Next Next.js" [ref=e331] [cursor=pointer]:
                - /url: /frameworks/next/
                - img [ref=e332]
                - generic [ref=e334]:
                  - text: Next
