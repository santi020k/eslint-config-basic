...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/v1/tooling/libraries/
Call log:
  - navigating to "http://127.0.0.1:4173/v1/tooling/libraries/", waiting until "load"
