...
- Docs: [eslint.santi020k.me](https://eslint.santi020k.me/)
...
Auto-detects TypeScript, frameworks, and common tools from your `package.json`. See the [full docs](https://eslint.santi020k.me/) for all options.
