...
"@santi020k/eslint-config-vite": patch
"@santi020k/eslint-config-vue": patch
---

Upgrade the supported dependency ecosystem, adopt Lumen Astro 2, and resolve all known audit findings with patched transitive versions.
