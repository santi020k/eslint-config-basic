...
- Package changelogs under `packages/*/CHANGELOG.md` are generated by Changesets. Add release notes via `pnpm run changeset` and committed `.changeset/` files, not by hand-editing changelog markdown.
