...
- Use [Libraries](/v2/tooling/libraries) for framework-adjacent integrations such as Tailwind or Storybook.
- Use [Testing](/v2/tooling/testing) for Vitest, Playwright, Jest, Cypress, and Testing Library.
- Use [Formats](/v2/tooling/formats) for Markdown, MDX, JSONC, YAML, TOML, and GraphQL.
- Use [Tools](/v2/tooling/tools) for Prettier, CSpell, JSDoc, and Swagger.
- Use [Extensions](/v2/tooling/extensions) for rule packs such as Unicorn or SonarJS.
...
- [Integrations Package](/v2/packages/integrations)
- [CLI](/v2/guide/cli)
