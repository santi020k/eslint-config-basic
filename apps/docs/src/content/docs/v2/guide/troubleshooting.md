...
- [CLI](/v2/guide/cli) — `doctor`, `explain`, `inspect` command reference
- [Configuration](/v2/guide/configuration) — full option reference
- [Monorepo](/v2/guide/monorepo) — monorepo-specific setup guidance
- [Migration v1 to v2](/v2/guide/migration-v1-to-v2)
