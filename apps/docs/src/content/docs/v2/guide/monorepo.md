...
- [Presets](/v2/guide/presets) — available preset values and what each enables
- [Runtime](/v2/guide/runtime) — runtime enum and auto-detection rules
- [Configuration](/v2/guide/configuration) — full option reference
- [CLI](/v2/guide/cli) — `doctor` and `inspect` commands for diagnosing monorepo setups
