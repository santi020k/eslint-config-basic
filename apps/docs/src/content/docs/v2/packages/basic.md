...
Use this package by default. If a project needs a smaller install and is willing to install framework and integration config packages manually, see the [Lite Package](/v2/packages/lite).
