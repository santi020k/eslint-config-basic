...
<InstallTabs packages={["@santi020k/eslint-config-lite", "@santi020k/eslint-config-nuxt", "eslint"]} />
...
- Pair this config with the [Vue config](/v2/frameworks/vue) — auto-detection handles this for you.
- The internal package still exists in the monorepo for modular development and generated API docs.

## Related Pages

- [Vue](/v2/frameworks/vue)
