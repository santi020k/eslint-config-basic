...
Defined in: [react/src/index.ts:51](https://github.com/santi020k/eslint-config-basic/blob/main/packages/react/src/index.ts#L51)
...
Defined in: [react/src/rules.ts:4](https://github.com/santi020k/eslint-config-basic/blob/main/packages/react/src/rules.ts#L4)
