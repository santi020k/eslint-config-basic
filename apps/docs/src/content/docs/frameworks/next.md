...
```sh title="pnpm"
pnpm add -D @santi020k/eslint-config-lite @santi020k/eslint-config-next eslint
```
...
- For the old multi-package installation model, see the [v1 Next.js guide](/v1/frameworks/next).
