...
<CardGrid>
  ...
  <Card title="Enum Based Toggles" icon="setting">
    Integrations can be enabled through enums, matching strings, or the simple `features` map.
  </Card>
  <Card title="Flexible Versions" icon="puzzle">
    ESLint can still be installed manually if you want to pin it yourself, as long as you stay on `^10`.
  </Card>
</CardGrid>
